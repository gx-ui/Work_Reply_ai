...
class MilvusSearchTool:
    ...
    def __init__(self, milvus_config: Dict[str, Any], embedder_config: Dict[str, Any]):
        ...
        self._connection_alias = "milvus_tool"
    ...
    def _init_connection(self):
        ...
        try:
            connections.get_connection_addr(self._connection_alias)
        ...
        if search_results and len(search_results) > 0:
            for hit in search_results[0]:
                ...
                item = {
                    ...
                    "file_name": entity.get(filter_field, "") if entity else "",
                    "score": hit.score,
                    "id": hit.id
                }
                if entity:
